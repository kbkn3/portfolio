...
const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    details: (
      <>
        <p>大学の新入生に基本的なPC操作から、Excel、PowerPoint、Wordまでを教える講座の講師を務めました。技術・スキルの多様さやカリキュラム改善への熱意を認められ、オンライン講座の新規開発事業にインターン生として参加しました。</p>
        <p className="mt-2">開発に際し「対面ではなく、動画のみで伝えなければならない」「受講者が満足感を得られる動画演出が必要」という課題に取り組み、様々なジャンルの講義動画を研究し、繰り返し収録と修正を行いました。</p>
        <div className="mt-3">
          <h4 className="text-sm font-medium text-gray-300 mb-1">主な担当業務</h4>
  ...
  },
  {
    ...
    description: "TA（ティーチングアシスタント）として生徒に様々なデジタルなものづくりの手助けを行いました。",
    color: "bg-red-400",
    organization: "学校法人角川ドワンゴ学園 N高等学校",
    details: (
      <>
        <p>オンラインと対面の両方の授業形式でサポートを提供。生徒の個人プロジェクトの指導や、グループワークのファシリテーションを担当。特にゲーム開発とデータ分析の分野で多くの生徒の成長をサポートしました。</p>
        <p className="mt-2">職員と生徒の間に立ち、相談や情報共有の役割も担いました。</p>
        <div className="grid grid-cols-2 gap-2 mt-3">
          <div className="bg-gray-700 rounded p-2">
            <h4 className="text-sm font-medium text-gray-300 mb-1">プログラミング</h4>
  ...
  },
  {
    ...
    period: "2022 - now",
    title: "Webエンジニア",
    description: "不動産ポータルサイトLIFULL HOME'Sのサービスの開発を行っています。現在は社内ABテスト基盤PJを立ち上げ、社内導入推進中。",
    color: "bg-orange-400",
    organization: "株式会社LIFULL",
    details: (
      <>
        <p>フロントエンド開発を中心に、バックエンドやインフラ構築まで幅広く担当。ABテスト基盤プロジェクトではリードエンジニアとして、要件定義から設計、実装、社内展開までを主導。React、TypeScript、AWS等の最新技術を活用したシステム開発に従事しています。</p>
        <div className="mt-3">
          <h4 className="text-sm font-medium text-gray-300 mb-1">使用技術</h4>
          <div className="flex flex-wrap gap-1 mt-1">
            <span className="px-2 py-1 bg-blue-900 bg-opacity-50 rounded text-xs">React</span>
            <span className="px-2 py-1 bg-blue-900 bg-opacity-50 rounded text-xs">TypeScript</span>
            <span className="px-2 py-1 bg-blue-900 bg-opacity-50 rounded text-xs">Next.js</span>
            <span className="px-2 py-1 bg-blue-900 bg-opacity-50 rounded text-xs">AWS</span>
            <span className="px-2 py-1 bg-blue-900 bg-opacity-50 rounded text-xs">Docker</span>
            <span className="px-2 py-1 bg-blue-900 bg-opacity-50 rounded text-xs">Python</span>
          </div>
        </div>
        <div className="mt-3">
          <h4 className="text-sm font-medium text-gray-300 mb-1">テックブログ記事</h4>
          <ul className="pl-5 space-y-1 text-sm text-gray-300 list-none">
            <li>
              <a href="https://www.lifull.blog/entry/2023/04/04/170000" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline flex items-center">
                <ExternalLinkIcon size="sm" className="mr-1 inline" />
                新卒エンジニアがリファクタを突貫したClean Architectureプロジェクトの舞台裏
              </a>
            </li>
            <li>
              <a href="https://www.lifull.blog/entry/2024/04/05/120000" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline flex items-center">
                <ExternalLinkIcon size="sm" className="mr-1 inline" />
                モバイルでのタップ成功率を可視化するツールの開発
              </a>
            </li>
            <li>
              <a href="https://www.lifull.blog/entry/2024/08/27/170000" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline flex items-center">
                <ExternalLinkIcon size="sm" className="mr-1 inline" />
  ...
  },
  {
    ...
    period: "2022 - now",
    title: "個人開発",
    description: "麻雀関連のアプリケーション開発や技術記事の執筆を行っています。",
    color: "bg-blue-400",
    organization: "個人活動",
    details: (
      <>
        <p>麻雀に関する個人開発プロジェクトを複数進行中。ネット麻雀アプリ向けのブラウザ拡張機能をリリースし、ユーザーから好評を得ています。また、麻雀AIの技術比較や分析に関する記事も執筆しています。</p>
        <div className="mt-3">
          <h4 className="text-sm font-medium text-gray-300 mb-1">主な成果物</h4>
          <ul className="list-none pl-5 space-y-1 text-sm text-gray-300">
            <li>
              <a href="https://chromewebstore.google.com/detail/%E9%9B%80%E9%AD%82%E7%89%8C%E8%AD%9C%E6%A4%9C%E8%A8%8E%E3%82%B5%E3%83%9D%E3%83%BC%E3%82%BF%E3%83%BC/kdmfnkdgpialmejpgflfllkjakolamcc?hl=ja" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline flex items-center">
                <ExternalLinkIcon size="sm" className="mr-1 inline" />
                ネット麻雀アプリ向けブラウザ拡張機能
              </a>
            </li>
            <li>
              <a href="https://qiita.com/Kenta_Kobayashi/items/3b5be9224065663279f6" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline flex items-center">
                <ExternalLinkIcon size="sm" className="mr-1 inline" />
...
const ExperienceSection = () => {
  ...
  const DetailDialog = () => {
    ...
    return (
      <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 ${isDialogOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'} transition-opacity duration-300`}>
        {/* オーバーレイ */}
        <div 
        ...
        <div className="relative bg-gray-800 rounded-lg shadow-xl max-w-lg w-full max-h-[80vh] overflow-auto z-10 transform transition-transform duration-300">
          ...
          <div className="p-6">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h2 className="text-xl font-bold text-white">{selectedExp.title}</h2>
                <div className="text-sm text-gray-400 mt-1">{selectedExp.period}</div>
                <div className="text-md font-medium text-gray-300 mt-1">{selectedExp.organization}</div>
              </div>
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-gray-300 mb-4">{selectedExp.description}</p>
              
              {selectedExp.details && (
                <>
                  <h3 className="text-md font-medium text-gray-300 mb-2">詳細</h3>
                  <div className="text-sm text-gray-300">{selectedExp.details}</div>
                </>
              )}
              
              {selectedExp.links && selectedExp.links.length > 0 && (
                <div className="mt-4 pt-4 border-t border-gray-700">
                  <h3 className="text-md font-medium text-gray-300 mb-2">関連リンク</h3>
